...
| 家务抽奖大转盘 | `/tools/家务抽奖大转盘.html` | 粘贴人员和家务两列表格，用转盘动画随机生成家务分配结果 |
...
- `v1.0.3`：新增家务抽奖大转盘工具，支持粘贴两列表格并随机分配人员与家务。
- `v1.0.2`：区分门户版本和工具独立版本；工具页页脚显示具体工具名称与版本；工具目录 API 增加 `version` 字段。
